...
from vila.eval.mmmu_utils.data_utils import CAT_SHORT2LONG, construct_prompt, load_yaml, process_single_sample
from vila.mm_utils import opencv_extract_frames, process_image, tokenizer_image_token
from vila.model import *
from vila.train.args import DataArguments, TrainingArguments
from vila.train.sequence_parallel import (
    extract_local_from_list,
    extract_local_input_ids,
    extract_local_position_ids,
    get_pg_manager,
)
from vila.utils.tokenizer import preprocess_conversation
...
class LazyCoyoDataset_LONGSEQ(Dataset):
    ...
    def __init__(
        ...
        from vila.train.llama_dpsp_attn_monkey_patch import get_sequence_parallel_rank, get_sequence_parallel_size
...
class LazyVideoWebDataset(Dataset):
    ...
    def __init__(
        ...
        # from vila.data.simple_video_dataset import SimpleVideoDataset
...
def build_datasets(
    ...
    for dataset in mixture:
        ...
        if dataset_type == "torch":
            ...
            from vila.data.dataset_impl.sam import LazySAMWebDataset

            dataset_cls = LazySAMWebDataset
        elif dataset_type == "sam-wds-tmp":
            print("dataset.py: Loading SAM class")
            from vila.data.dataset_impl.sam_tmp import LazySAMTmpWebDataset
            ...
            print("dataset.py: Loading VILAPanda70m class")
            from vila.data.dataset_impl.general_img_text import LazyImageTextWebDataset
