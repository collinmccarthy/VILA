...
from vila.mm_utils import process_images

from argparse import ArgumentParser

from vila.eval.mmmu_utils.data_utils import (
    load_yaml,
    construct_prompt,
    save_json,
...
from vila.eval.mmmu_utils.model_utils import (
    call_llava_engine_df,
    llava_image_processor,
)
from vila.eval.mmmu_utils.eval_utils import (
