...
from vila.model.llava_arch import LlavaMetaModel, LlavaMetaForCausalLM
from vila.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN
...
if __name__ == "__main__":
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        (input_ids_after, position_ids_after, attention_mask_after, _, inputs_embeds, _) = (
